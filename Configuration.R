...
if (Project == 'MAIRE') {
  ...
  VRPlot$PV5 <- c('DP_DPR', 'DP_DPL', 'DP_VXL', 'ATX', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCFC', 'LSRINT_VXL', 'EW_DPL', 'EW_DPR', 'MR', 'EW_VXL', 'QCXC', 'AKRD', 'MACHX', 'SMPLSRINT_VXL', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCXC', 'MACHX', 'AKRD', 'MR', 'LSRINT_VXL')
  ...
  VRPlot$PV10 <- c('GGVEW', 'VEW', 'GGVNS', 'VNS', 'GGQUAL', 'VEWC', 'VNSC', 'GGNSAT')
  ...
  VRPlot$PV21 <- c('TASX')
  VRPlot$PV22 <- c('TASX')
  VRPlot$PV23 <- c('TASX', 'CO_PIC2401', 'COCAL_PIC2401', 'COCOR_PIC2401', 'COZRO_PIC2401', 'CH4_PIC2401', 'CH4C_PIC2401', 'CO2_PIC2401', 'CO2C_PIC2401', 'H2O_PIC2401', 'CO_ARI', 'COA_ARI', 'COCAL_ARI', 'COCOR_ARI', 'COZRO_ARI', 'H2O_ARI', 'N2O_ARI', 'N2OA_ARI', 'P_ARI', 'T_ARI', 'INLETP_AL_CTI1')
...
if (Project == 'ACCLIP') {
  ...
  VRPlot$PV5 <- c('DP_DPR', 'DP_DPL', 'DP_VXL', 'ATX', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCFC', 'SMPLSRINT_VXL', 'EW_DPL', 'EW_DPR', 'MR', 'EW_VXL', 'QCXC', 'AKRD', 'MACHX', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCXC', 'MACHX', 'AKRD', 'MR')
  VRPlot$PV6 <- c('PSFC', 'PS_A', 'PSF', 'PSFF', 'PSFFC', 'PSTF', 'PSX', 'PS_A2', 'PS_VXL', 'PSTFC')
  VRPlot$PV7 <- c('QCFC', 'TASF', 'MACHF', 'QCF', 'QCR', 'QCRC', 'QC_A', 'TASR', 'TASDRY', 'TAS_A', 'MACHR', 'MACH_A', 'MACH_A2', 'QCTF', 'QCTFC')
  VRPlot$PV8 <- c('PSF', 'QCF', 'PS_A', 'QC_A', 'PSTF', 'QCTF')
  VRPlot$PV9 <- c('WDC', 'IWD', 'WSC', 'IWS', 'WIC', 'ADIFR', 'WD', 'WS', 'WIY', 'IWD_IRS2', 'IWD_IRS3', 'IWS_IRS2', 'IWS_IRS3', 'WIX')
  ...
  VRPlot$PV11 <- c('AKRD', 'PITCH', 'VSPD_A', 'TASX', 'SSRD', 'WDC', 'WSC', 'GGVEW', 'GGVNS', 'GGVSPD', 'ADIFR', 'BDIFR', 'THDG')
  VRPlot$PV12 <- c('PITCH', 'PITCH_IRS3', 'ROLL', 'ROLL_IRS3', 'THDG', 'THDG_IRS3', 'PITCH_IRS2', 'ROLL_IRS2', 'THDG_IRS2')
  VRPlot$PV13 <- c('ACINS', 'ACINS_IRS3', 'VSPD', 'VSPD_A', 'GGALT', 'ALT_A', 'ACINS_IRS2', 'GGVSPD', 'VSPD_A2', 'VSPD_IRS2', 'VSPD_IRS3', 'ALT', 'ALT_A2', 'ALT_IRS2', 'ALT_IRS3', 'GEOPTH')
  VRPlot$PV14 <- c('')
  VRPlot$PV15 <- c('CONCD_LWOO', 'CONCU_TOP', 'CONCU100_TOP', 'CONCU500_TOP', 'UREF_TOP', 'USCAT_TOP', 'BCPC_SP2', 'UFLWC_TOP')
  VRPlot$PV16 <- c('PLWCC', 'PLWC', 'RICE', 'DBARD_LWOO', 'PLWCD_LWOO', 'TCNTD_LWOO', 'REJDOF_LWOO', 'AVGTRNS_LWOO', 'CDPLSRP_LWOO', 'CDPCBTMP_LWOO', 'CDPLBTMP_LWOO', 'CDPWBTMP_LWOO', 'CDPLSRC_LWOO', 'DBARU_TOP', 'DBARS_2DS')
  VRPlot$PV17 <- c('PSXC', 'ATX', 'DPXC', 'GGALT')
  VRPlot$PV18 <- c('PSXC', 'ATX', 'DPXC', 'GGALT')
  VRPlot$PV19 <- c('THETA', 'THETAV', 'THETAE', 'THETAP', 'THETAQ', 'PSXC', 'ATX', 'EWX', 'PLWCC')
  VRPlot$PV20 <- c('TASX', 'CCDP_LWOO', 'CONCD_LWOO')
  VRPlot$PV21 <- c('TASX', 'CUHSAS_TOP', 'CONCU_TOP')
  VRPlot$PV22 <- c('TASX')
  VRPlot$PV23 <- c('FO3_ACD', 'TASX', 'CO_PIC2401', 'COCAL_PIC2401', 'COCOR_PIC2401', 'COZRO_PIC2401', 'CH4_PIC2401', 'CH4C_PIC2401', 'CO2_PIC2401', 'CO2C_PIC2401', 'H2O_PIC2401', 'COA_ARI', 'COCAL_ARI', 'COCOR_ARI', 'COZRO_ARI', 'CO_ARI', 'H2O_ARI', 'N2OA_ARI', 'N2O_ARI', 'P_ARI', 'T_ARI', 'VMR_VXL')
  VRPlot$PV24 <- c('ATX', 'TASX')
  VRPlot$PV25 <- c('ATX', 'TASX')
