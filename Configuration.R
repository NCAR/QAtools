...
if (Project == 'ACCLIP') {
  ...
  VRPlot$PV5 <- c('DP_DPR', 'DP_DPL', 'DP_VXL', 'ATX', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCFC', 'LSRINT_VXL', 'EW_DPL', 'EW_DPR', 'MR', 'EW_VXL', 'QCXC', 'AKRD', 'MACHX', 'CAVP_2DS', 'CAVP_DPL', 'CAVP_DPR', 'PSXC', 'QCXC', 'MACHX', 'AKRD', 'MR', 'LSRINT_VXL')
